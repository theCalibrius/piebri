...
class Terminal extends Component {
  ...
  fireCursorBlinkInterval() {
    setTimeout(() => {
      if (this.refs.cursor) {
        this.refs.cursor.style.visibility =
          this.refs.cursor.style.visibility === 'visible' ? 'hidden' : 'visible';
        this.fireCursorBlinkInterval();
      }
    }, 500);
  }
  ...
  isEmailValid(addressToValidate) {
    return new Promise((resolve) => {
      axios
        .post('https://7ljv2tt4yl.execute-api.us-east-1.amazonaws.com/prod/ValidateEmailAddress', {
  ...
  sendMessage() {
    ...
    axios
      .post('https://u9udukv8j0.execute-api.us-east-1.amazonaws.com/prod/ContactFormLambda', {
